...
from sensirion_i2c_sht4x.response_provider import Sht4xResponseProvider
...
def channel_provider(request):
    ...
    if serial_port is not None:
        ...
        yield MockI2cChannelProvider(command_width=1,
                                     response_provider=Sht4xResponseProvider())