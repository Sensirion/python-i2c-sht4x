...
1. Install the SHT4X driver and all required packages as described in :ref:`Installation`.
...
.. literalinclude:: ../examples/example_usage_sensorbridge_sht4x.py
    :language: python
...
.. literalinclude:: ../examples/example_usage_linux_sht4x.py
    :language: python
